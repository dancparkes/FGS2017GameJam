x = oTestArmLeft.x + lengthdir_x(startPosition, oTestArmLeft.direction);
y = oTestArmLeft.y + lengthdir_y(startPosition, oTestArmLeft.direction);
...
direction = oTestArmLeft.direction;
image_angle = direction;
